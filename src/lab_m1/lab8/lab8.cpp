...
void Lab8::Update(float deltaTimeSeconds)
{
    ...
    // Render ground
    {
        ...
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3(0, 0, 0));
...
void Lab8::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    int spotL_location = glGetUniformLocation(shader->program, "spotL");
    glUniform1i(spotL_location, spotL);

    // TODO(student): Set any other shader uniforms that you need
    GLint loc_light_direction = glGetUniformLocation(shader->program, "light_direction");
    glUniformMatrix3fv(loc_light_direction, 1, GL_FALSE, glm::value_ptr(lightDirection));
