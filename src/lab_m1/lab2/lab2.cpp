...
void Lab2::Init()
{
...

    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(1, -1, 1), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // 1
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // 2
            VertexFormat(glm::vec3(0, -1, -1), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)), // 3

            VertexFormat(glm::vec3(-1, -1, 1), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), // 4
            VertexFormat(glm::vec3(1, -1, 1), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // 5
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // 6
            VertexFormat(glm::vec3(0, -1, -1), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // 7

            VertexFormat(glm::vec3(-1, -1, 1), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)), // 8
            VertexFormat(glm::vec3(1, -1, 1), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)), // 9
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), // 10
            VertexFormat(glm::vec3(0, -1, -1), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), // 11
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(2.5f, 0.5f, 0), glm::vec3(0.5f));
    ...
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(-3, 0.5f, 1), glm::vec3(1));
